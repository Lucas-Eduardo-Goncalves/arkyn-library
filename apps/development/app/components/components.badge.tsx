...
export default function BadgeRoute() {
	return (
		<>
			...
			<div className="exampleContainer row">
				<Badge scheme="primary" variant="solid" size="md">
					Size md
				</Badge>
				<Badge scheme="primary" variant="solid" size="lg">
					Size lg
				</Badge>
				<Badge scheme="success" variant="ghost" size="md">
					Size md
				</Badge>
				<Badge scheme="success" variant="ghost" size="lg">
					Size lg
				</Badge>
			</div>

			<div className="exampleContainer row">
				<Badge scheme="primary" variant="solid" rightIcon={CircleDashed}>
					Right icon
				</Badge>
				<Badge scheme="info" variant="outline" rightIcon={CircleDashed}>
					Right icon
				</Badge>
				<Badge
